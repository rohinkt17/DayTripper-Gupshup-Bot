function MessageHandler(context, event) {
    ...
    if (event.message.indexOf("@")!=-1)
    {
        ...
        switch(condition) {
            case "Clouds" : context.sendResponse("It's going to be cloudy.");
                break;
            case "Rain" : context.sendResponse("You'll need an umbrella--it's going to be raining.");
                break;
            case "Clear" : context.sendResponse("Clear skies ahead!");
                break;
        }
